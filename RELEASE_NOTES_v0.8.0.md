...
This release introduces several new features and improvements, including enhanced support for split Seurat objects and more flexible layer selection options.
...
- GitHub prerelease tag/title: `v0.8.0`.
